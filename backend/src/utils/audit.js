...
async function logAudit(db, { userId, userName, userRole, action, module, entityType, entityId, entityReference, description, outcome = 'SUCCESS', beforeData = {}, afterData = {}, changes = [], metadata = {}, storeId, itemId, locationId, bin }) {
  ...
  await execute(
    ...
    [userId || null, userName || 'System', userRole || null, action, module, entityType || null, entityId || null, entityReference || null, description || action, outcome, beforeData, afterData, changes, auditMetadata]
  );
}
